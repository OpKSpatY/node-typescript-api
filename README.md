API desenvolvida com finalidade de estudos durante o curso DO ZERO A PRODUÇÃO: APRENDA A CONSTRUIR UMA API NODE.JS COM TYPESCRIPT, links disponíveis na descrição do readme.
